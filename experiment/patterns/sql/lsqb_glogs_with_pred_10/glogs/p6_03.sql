...
JOIN (SELECT * FROM person v2 WHERE v2.birthday <= 631152000000) v2 ON v2.id = e1.dst
JOIN (SELECT * FROM post v4 WHERE v4.explicitlydeleted = false) v4 ON v4.id = e3.dst
