...
JOIN (SELECT * FROM comment v4 WHERE v4.creationdate >= 1262304000000 AND v4.explicitlydeleted = false) v4 ON v4.id = e4.src
JOIN (SELECT * FROM tag v5 WHERE v5.name = 'Rumi') v5 ON v5.id = e3.dst
