SELECT COUNT(*)
FROM (SELECT * FROM forum_hasmember_person e1 WHERE e1.creationdate >= 1262304000000 AND e1.deletiondate >= 1356998400000) e1
...
JOIN (SELECT * FROM post v4 WHERE v4.browserused = 'Chrome' AND v4.explicitlydeleted = false) v4 ON v4.id = e3.dst
