...
JOIN (SELECT * FROM person v4 WHERE v4.birthday <= 631152000000) v4 ON v4.id = e3.dst
JOIN (SELECT * FROM comment v1 WHERE v1.explicitlydeleted = false AND v1.browserused = 'Chrome') v1 ON v1.id = e1.src
