SELECT COUNT(*)
FROM (SELECT * FROM person_knows_person e1 WHERE e1.creationdate >= 1325376000000 AND e1.deletiondate >= 1356998400000) e1
...
JOIN (SELECT * FROM person v1 WHERE v1.gender = 'male' AND v1.browserused = 'Chrome') v1 ON v1.id = e1.src
