...
JOIN (SELECT * FROM person_knows_person e2 WHERE e2.deletiondate <= 1577664000000) e2 ON e2.src = e1.src
...
JOIN (SELECT * FROM person v1 WHERE v1.birthday >= 315532800000 AND v1.gender = 'male') v1 ON v1.id = e1.src
