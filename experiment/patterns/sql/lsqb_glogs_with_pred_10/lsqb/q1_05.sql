...
JOIN (SELECT * FROM post v5 WHERE v5.creationdate >= 1285917807738 AND v5.explicitlydeleted = false) v5 ON v5.id = e3.dst
JOIN (SELECT * FROM comment v6 WHERE v6.browserused = 'Chrome') v6 ON v6.id = e2.src
