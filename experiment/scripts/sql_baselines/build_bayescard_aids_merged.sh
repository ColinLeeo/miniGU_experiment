...
output_dir=$workspace/result/sql_baselines/aids_merged_7baselines/bayescard
artifact=$output_dir/bayescard.pkl
log=$workspace/result/sql_baselines/aids_merged_7baselines/bayescard/build.log
mkdir -p "$output_dir"

run_build_with_metrics "$log" "BayesCard" "aids_merged" "1" "$artifact" \
